...
export const infrastructureHandler: InfrastructureServiceHandler = {
  ...
  getIpGeo: async (_ctx, _req) => ({ country: '', region: '', city: '' }),
  reverseGeocode: async (_ctx, _req) => ({ country: '', code: '', displayName: '', error: '' }),
  getBootstrapData: async (_ctx, _req) => ({ data: {}, missing: [] }),
};
